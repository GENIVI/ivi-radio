...
Station::Station(const uint32_t& flagsValue, const Types::Types::UInt32s& genreValue, const Metadatas& metaValue, const Types::Types::Strings& nameValue, const Types::Types::UInt32s& qualityValue, const Types::Types::StationSelector& selValue, const uint32_t& stationTypeValue):
        flags(flagsValue),
        genre(genreValue),
        meta(metaValue),
        name(nameValue),
